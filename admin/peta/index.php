...
if (!in_array($tab, ['informasi', 'jam', 'layanan'], true)) {
$tab = 'layanan';
}
if (!in_array($jenis_jadwal, ['reguler', 'kondisional'], true)) {
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php if ($r['jam_id']): ?>
                    <div class="jadwal">
                        <div class="data-box"><?=jam($r['hari_biasa_mulai'])?></div>
                        <span>—</span>
                        <div class="data-box"><?=jam($r['hari_biasa_selesai'])?></div>
                        <span style="color:#98a2b3;font-size:10px">Biasa</span>
                        <div class="data-box"><?=jam($r['akhir_pekan_mulai'])?></div>
                        <span>—</span>
                        <div class="data-box"><?=jam($r['akhir_pekan_selesai'])?></div>
                        <span style="color:#98a2b3;font-size:10px">Weekend</span>
                    </div>
                    <?php else: ?>
                    <span style="color:#98a2b3;font-size:11px">Belum diatur</span>
                    <?php endif; ?>
                </td>
                ...
                <td>
                    <div class="actions">
                        <?php if ($r['jam_id']): ?>
                        <button class="action edit" onclick='openEditReguler(
                ...
                <?php else: ?>
                <button class="action edit" onclick="openAddReguler(<?=$r['id']?>)">
                    <i class="fa-solid fa-plus"></i>
                </button>
                <?php endif; ?>
            </div>
    ...
    <tr>
        ...
        <td>
            <div style="display:flex;gap:30px;align-items:center">
                <span style="font-size:11px;color:#667085"><?=e($r['jenis'])?></span>
                <strong style="font-size:12px"><?=e($nilai)?></strong>
            </div>
        </td>

        <td>
            <div class="actions">
                <button class="action edit" onclick='openEditKondisional(
                <?=json_encode((int)$r["id"])?>,
