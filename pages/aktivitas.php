...
<section class="pt-3 pb-5 bg-light">
    <div class="container pt-2 pb-4">
        ...
        <section class="pt-4">
            ...
            <!-- PERUBAHAN: row-cols-md-3 & justify-content-center -->
                ...
                <div class="col">
                    <article class="card h-100 border-0 rounded-4 shadow-sm overflow-hidden">
                        ...
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <p class="card-text text-secondary small mb-4 flex-grow-1">Berbagai kegiatan, acara, olahraga, dan aktivitas masyarakat yang berlangsung di IKN.</p>
