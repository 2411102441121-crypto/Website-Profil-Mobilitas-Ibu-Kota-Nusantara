...
<main class="active-page">
    ...
    <section class="active-hero">
        ...
        <img
            src="../assets/images/intrakota/mobilitas-aktif.jpg"
            alt="Jalur Pejalan Kaki dan Mobilitas Aktif IKN"
        >
    ...
    <section class="priority-section">
        ...
        <div class="section-title">
            ...
            <div>
                <h2>Koridor Prioritas Pejalan Kaki &amp; Skywalk</h2>

                <p>
                    Jalur konektivitas aktif terlindung cuaca
                    dengan sirkulasi udara sejak 24 jam
                </p>
            </div>

            <div class="corridor-filter">
                <button class="active">Semua Koridor</button>
                <button>Elevated Skywalk</button>
                <button>Jalur Peneduh</button>
            </div>
        ...
        <div class="corridor-grid">
            ...
            <div class="corridor-card">
                ...
                <div class="corridor-code">K1</div>

                <div>
                    <h3>Sumbu Kebangsaan Promenade</h3>
                    ...
                    <p>
                        <strong>Jalur:</strong>
                        Berdampingan Terproteksi
                    </p>

                    <p>
                        <strong>Kanopi:</strong>
                        Alami &amp; Solar Sensor Pintar
                    </p>
                </div>
            ...
            <div class="corridor-card">
                ...
                <div class="corridor-code">K2</div>

                <div>
                    <h3>Skywalk Plaza - Kemenko</h3>
                    ...
                    <p>
                        <strong>Akses inklusif:</strong>
                        Ramp &amp; Lift di titik Kemenko
                    </p>
            ...
            <div class="corridor-card">
                ...
                <div class="corridor-code">K3</div>

                <div>
                    <h3>Lingkar Hijau Rusun ASN</h3>

                    <p>
                        <strong>Kanopi:</strong>
                        Misting Fan Pukul 11-15
                    </p>

                    <p>
                        <strong>Micro:</strong>
                        Lebar 5m + Guiding Block
                    </p>

                    <p>
                        <strong>Koneksi Transit:</strong>
                        &lt; 3 Menit ke Halte EV
                    </p>
                </div>
            ...
            <div class="corridor-card">
                ...
                <div class="corridor-code">K4</div>

                <div>
                    <h3>Wetland Botanical Loop</h3>

                    <p>
                        <strong>Permukaan:</strong>
                        Porous Bio-Pavement
                    </p>
    ...
    <section class="bike-banner">
        ...
        <a href="mikromobilitas.php" class="bike-button">
            Buka Halaman Mikromobilitas →
        </a>
