...
<main class="micro-page">
    ...
    <section class="fleet-section">
        ...
        <div class="fleet-heading">
            ...
            <div>
                ...
                <h2>
                    Pilihan Armada & Spesifikasi Sepeda
                </h2>

                <p>
                    Semua unit dilengkapi sensor telemetri cerdas,
                    GPS dual-band, IoT geofence, pembatas kecepatan
                    otomatis, dan kunci digital.
                </p>
            </div>

            <div class="fleet-emission">
                ● 100% Nol Emisi Langsung
            </div>
        ...
        <div class="fleet-grid">
            ...
            <article class="fleet-card">
                ...
                <div class="fleet-title">
                    ...
                    <small>
                        Smart Pedal Assist (PAS)
                    </small>

                    <h3>
                        Nusantara E-Bike Gen 2
                    </h3>
                ...
                <div class="spec-list">
                    ...
                    <div>
                        ...
                        <strong>20 km/jam</strong>
                    </div>

                    <div>
                        <span>Jarak Tempuh Baterai</span>
                        <strong>55 - 60 km per pengisian</strong>
                    </div>

                    <div>
                        <span>Sistem Pengereman</span>
                        <strong>Rem Regeneratif + Drum Brake</strong>
                    </div>

                    <div>
                        <span>Fitur Penunjang</span>
                        <strong>Keranjang Bawaan + Holder HP</strong>
                    </div>

                </div>

                <p class="fleet-note">
                    Sangat bertenaga untuk jalur kontur perbukitan
                    hijau KIPP, memudahkan perjalanan pulang-pergi
                    kantor tanpa lelah berlebihan.
                </p>
            ...
            <article class="fleet-card">
                ...
                <div class="fleet-title">
                    ...
                    <small>
                        Mobilitas Aktif Berkelanjutan
                    </small>

                    <h3>
                        City Bike Manual 7-Speed
                    </h3>
                ...
                <div class="spec-list">
                    ...
                    <div>
                        <span>Sistem Transmisi</span>
                        <strong>Shimano Nexus 7-Speed Internal</strong>
                    </div>

                    <div>
                        <span>Keamanan Kunci</span>
                        <strong>Solar Smart Lock IoT</strong>
                    </div>

                    <div>
                        <span>Tipe Ban</span>
                        <strong>Airless Puncture-Proof 26"</strong>
                    </div>

                    <div>
                        <span>Kapasitas Muatan</span>
                        <strong>Keranjang Depan Maks 15 kg</strong>
                    </div>

                </div>

                <p class="fleet-note">
                    Pilihan ideal bagi warga yang menyukai kebugaran
                    fisik sambil menikmati udara sejuk hutan tropis
                    basah di pagi atau sore hari.
                </p>
            ...
            <article class="fleet-card">
                ...
                <div class="fleet-top">
                    ...
                    <div>
                        <span class="fleet-label">
                            PILOTING TERBATAS PEGAWAI & WISATA
                        </span>
                    </div>
                ...
                <div class="fleet-title">
                    ...
                    <small>
                        Urban Micro-Glide + Scan QR Mitra Darat
                    </small>
                ...
                <div class="spec-list">
                    ...
                    <div>
                        ...
                        <strong>SSO ASN / Reservasi Umum</strong>
                    </div>

                    <div>
                        <span>Batas Kecepatan</span>
                        <strong>18 km/jam (10 km/jam di Plaza)</strong>
                    </div>

                    <div>
                        <span>Lokasi Parkir</span>
                        <strong>Wajib Solar Docking Hub</strong>
                    </div>

                    <div>
                        <span>Sistem Keamanan</span>
                        <strong>Geofence Lock + Dual E-ABS</strong>
                    </div>

                </div>

                <p class="fleet-note">
                    Tahap uji coba operasional terbatas untuk ASN
                    antar-kantor kementerian dan area publik akhir
                    pekan di Plaza Serambi via verifikasi identitas.
                </p>
    ...
    <section class="micro-detail-section">
